...
namespace Microsoft.Azure.MachineLearning.Services
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<AzureMachineLearningServiceClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(AzureMachineLearningServiceClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<AsyncOperationStatus>> GetWithHttpMessagesAsync(System.Guid subscriptionId, string resourceGroup, string workspace, string id, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "modelmanagement/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.MachineLearningServices/workspaces/{workspace}/operations/{id}").ToString();
