...
namespace Microsoft.Azure.MachineLearning.Services.Models
{
    ...
    public partial class Model
    {
        ...
        /// are immutable.</param>
        public Model(string name, string url, string mimeType, string id = default(string), string framework = default(string), string frameworkVersion = default(string), long? version = default(long?), IList<DatasetReference> datasets = default(IList<DatasetReference>), string description = default(string), System.DateTime? createdTime = default(System.DateTime?), System.DateTime? modifiedTime = default(System.DateTime?), bool? unpack = default(bool?), string parentModelId = default(string), string runId = default(string), string experimentName = default(string), IDictionary<string, string> kvTags = default(IDictionary<string, string>), IDictionary<string, string> properties = default(IDictionary<string, string>))
        {
            Id = id;
            Name = name;
            Framework = framework;
        ...
        /// <summary>
        /// Gets the Model last modified time (UTC).
        /// </summary>
