...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class DataFactory : Compute
    {
        ...
        public DataFactory(string computeLocation = default(string), string provisioningState = default(string), string description = default(string), System.DateTime? createdOn = default(System.DateTime?), System.DateTime? modifiedOn = default(System.DateTime?), string resourceId = default(string), IList<MachineLearningServiceError> provisioningErrors = default(IList<MachineLearningServiceError>), bool? isAttachedCompute = default(bool?))
