...
namespace Microsoft.Azure.Management.MachineLearningServices
{
    ...
    /// </summary>
    internal partial class VirtualMachineSizesOperations : IServiceOperations<AzureMachineLearningWorkspacesClient>, IVirtualMachineSizesOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal VirtualMachineSizesOperations(AzureMachineLearningWorkspacesClient client)
        {
            if (client == null)
            {
